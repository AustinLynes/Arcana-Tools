...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            static ImGuiTextFilter filter;
            filter.DrawSprite("Filter colors", ImGui::GetFontSize() * 16);
...
struct ExampleAppConsole
{
    ...
    void    DrawSprite(const char* title, bool* p_open)
    {
        ...
        ImGui::SameLine();
        Filter.DrawSprite("Filter (\"incl,-excl\") (\"error\")", 180);
        ImGui::Separator();
...
static void ShowExampleAppConsole(bool* p_open)
{
    ...
    console.DrawSprite("Example: Console", p_open);
}
...
struct ExampleAppLog
{
    ...
    void    DrawSprite(const char* title, bool* p_open = NULL)
    {
        if (!ImGui::Begin(title, p_open))
        {
            ImGui::End();
        ...
        ImGui::SameLine();
        Filter.DrawSprite("Filter", -100.0f);
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    log.DrawSprite("Example: Log", p_open);
}
